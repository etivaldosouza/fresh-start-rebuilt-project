...
const HeroSection = () => {
  return (
    <section className="relative flex flex-col items-center justify-center gap-8 text-center py-16">
      ...
      <div className="relative z-10 space-y-10">
        ...
        />
        <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none heading-gradient max-w-3xl mx-auto">
        ...
        <p className="max-w-[800px] text-gray-500 md:text-xl dark:text-gray-400 mx-auto">
          Soluções financeiras seguras e transparentes para aposentados, pensionistas e servidores públicos.
          Atendimento personalizado e taxas competitivas.
        </p>
